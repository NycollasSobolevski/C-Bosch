public class Matriz
{
    ...
    public bool Identidade()                                                // conferir altura +1
    {
    ...
    public bool Diagonal()                                                // conferir altura +1
    {
        if(this.Altura != this.Largura)
            return false;
        for ( int i=0; i<this.Altura; i++)
    ...
    public bool Singular()                                                // conferir altura +1
    {
        if(!this.Diagonal())
            return false;
        for ( int i=0; i<this.Altura; i++)
    ...
    public bool Simetrica()                                                // conferir altura +1
    {
        for ( int i=0; i<this.Altura; i++)
        {
            for(int j=0; j<this.Largura; j++)
