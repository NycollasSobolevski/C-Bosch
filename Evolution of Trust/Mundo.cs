...
public static class Mundo               // 'static'
{
    ...
    public static void Jogada()
    {
        ...
        while(true)
        {
            jogador1 = Mundo.Players[r.Next(Mundo.Players.Length)]; //random.next serve como random.randint(python)
    ...
    {
        if (cooperadores + copiadores + trapaceiros > Mundo.Players.Length)
            throw new Exception();
